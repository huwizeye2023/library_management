...
// Fetch pending requests with member and book details
$stmt = $pdo->query("
...
<body>
    <div class="header">
        <h1>Borrow Requests - Librarian</h1>
        <div class="nav-links">
    ...
    <div class="container">
        ...
        <div class="table-card">
            <h3>Pending Borrow Requests (<?php echo count($pending_requests); ?>)</h3>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($request['member_email']); ?></td>
