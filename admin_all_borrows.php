...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-small { padding: 5px 10px; background: #667eea; color: white; border: none; border-radius: 3px; cursor: pointer; font-size: 11px; }
    </style>
</head>
<body>
    <div class="header">
        <h1>All Borrows - Admin</h1>
        <div class="nav-links">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $borrow['librarian_name'] ? htmlspecialchars($borrow['librarian_name']) : '-'; ?></td>
                        <td>
